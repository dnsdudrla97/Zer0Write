...
/**
 * Preserve readability by replacing specific long-dash glyphs
 * with plain-text safe equivalents during clean output generation.
 */
export const DASH_REPLACEMENTS: Record<string, string> = {
  '\u2014': '-', // —
  '\u2E3A': '->', // ⸺
  '\u2E3B': '->', // ⸻
};
